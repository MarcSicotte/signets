...
export default function ListeDossiers({utilisateur, dossiers, setDossiers}) {
  ...
  function modifierDossier(idDossier,nvTitre, nvCouverture, nvCouleur){
    const lesModifs = { //objet contenant les nouveaux champs du dossier triger
      titre: nvTitre,
      couverture : nvCouverture,
      couleur: nvCouleur
    }
    dossierModele.modifier(utilisateur.uid, idDossier, lesModifs).then( //chemin de firestore table utilisateur par id puis id du dossier à modifier puis les champs modifiés
